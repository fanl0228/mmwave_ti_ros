...
(cl:in-package ti_mmwave_tracker_rospkg-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <mmWaveCLI-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'mmWaveCLI-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ti_mmwave_tracker_rospkg-srv:<mmWaveCLI-request> is deprecated: use ti_mmwave_tracker_rospkg-srv:mmWaveCLI-request instead.")))

(cl:ensure-generic-function 'comm-val :lambda-list '(m))
(cl:defmethod comm-val ((m <mmWaveCLI-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ti_mmwave_tracker_rospkg-srv:comm-val is deprecated.  Use ti_mmwave_tracker_rospkg-srv:comm instead.")
  (comm m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<mmWaveCLI-request>)))
  ...
  "ti_mmwave_tracker_rospkg/mmWaveCLIRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'mmWaveCLI-request)))
  "Returns string type for a service object of type 'mmWaveCLI-request"
  "ti_mmwave_tracker_rospkg/mmWaveCLIRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <mmWaveCLI-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'mmWaveCLI-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ti_mmwave_tracker_rospkg-srv:<mmWaveCLI-response> is deprecated: use ti_mmwave_tracker_rospkg-srv:mmWaveCLI-response instead.")))

(cl:ensure-generic-function 'resp-val :lambda-list '(m))
(cl:defmethod resp-val ((m <mmWaveCLI-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ti_mmwave_tracker_rospkg-srv:resp-val is deprecated.  Use ti_mmwave_tracker_rospkg-srv:resp instead.")
  (resp m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<mmWaveCLI-response>)))
  ...
  "ti_mmwave_tracker_rospkg/mmWaveCLIResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'mmWaveCLI-response)))
  "Returns string type for a service object of type 'mmWaveCLI-response"
  "ti_mmwave_tracker_rospkg/mmWaveCLIResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'mmWaveCLI)))
  ...
  "ti_mmwave_tracker_rospkg/mmWaveCLI")