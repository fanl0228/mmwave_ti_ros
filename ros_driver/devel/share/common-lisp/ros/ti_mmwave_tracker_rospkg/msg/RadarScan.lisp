...
(cl:defmethod cl:initialize-instance :after ((m <RadarScan>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'RadarScan)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ti_mmwave_tracker_rospkg-msg:<RadarScan> is deprecated: use ti_mmwave_tracker_rospkg-msg:RadarScan instead.")))
...
(cl:defmethod point_id-val ((m <RadarScan>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ti_mmwave_tracker_rospkg-msg:point_id-val is deprecated.  Use ti_mmwave_tracker_rospkg-msg:point_id instead.")
  (point_id m))

(cl:ensure-generic-function 'x-val :lambda-list '(m))
(cl:defmethod x-val ((m <RadarScan>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ti_mmwave_tracker_rospkg-msg:x-val is deprecated.  Use ti_mmwave_tracker_rospkg-msg:x instead.")
  (x m))

(cl:ensure-generic-function 'y-val :lambda-list '(m))
(cl:defmethod y-val ((m <RadarScan>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ti_mmwave_tracker_rospkg-msg:y-val is deprecated.  Use ti_mmwave_tracker_rospkg-msg:y instead.")
  (y m))

(cl:ensure-generic-function 'z-val :lambda-list '(m))
(cl:defmethod z-val ((m <RadarScan>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ti_mmwave_tracker_rospkg-msg:z-val is deprecated.  Use ti_mmwave_tracker_rospkg-msg:z instead.")
  (z m))

(cl:ensure-generic-function 'range-val :lambda-list '(m))
(cl:defmethod range-val ((m <RadarScan>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ti_mmwave_tracker_rospkg-msg:range-val is deprecated.  Use ti_mmwave_tracker_rospkg-msg:range instead.")
  (range m))

(cl:ensure-generic-function 'velocity-val :lambda-list '(m))
(cl:defmethod velocity-val ((m <RadarScan>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ti_mmwave_tracker_rospkg-msg:velocity-val is deprecated.  Use ti_mmwave_tracker_rospkg-msg:velocity instead.")
  (velocity m))

(cl:ensure-generic-function 'doppler_bin-val :lambda-list '(m))
(cl:defmethod doppler_bin-val ((m <RadarScan>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ti_mmwave_tracker_rospkg-msg:doppler_bin-val is deprecated.  Use ti_mmwave_tracker_rospkg-msg:doppler_bin instead.")
  (doppler_bin m))

(cl:ensure-generic-function 'bearing-val :lambda-list '(m))
(cl:defmethod bearing-val ((m <RadarScan>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ti_mmwave_tracker_rospkg-msg:bearing-val is deprecated.  Use ti_mmwave_tracker_rospkg-msg:bearing instead.")
  (bearing m))

(cl:ensure-generic-function 'intensity-val :lambda-list '(m))
(cl:defmethod intensity-val ((m <RadarScan>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ti_mmwave_tracker_rospkg-msg:intensity-val is deprecated.  Use ti_mmwave_tracker_rospkg-msg:intensity instead.")
  (intensity m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<RadarScan>)))
  ...
  "ti_mmwave_tracker_rospkg/RadarScan")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'RadarScan)))
  "Returns string type for a message object of type 'RadarScan"
  "ti_mmwave_tracker_rospkg/RadarScan")
