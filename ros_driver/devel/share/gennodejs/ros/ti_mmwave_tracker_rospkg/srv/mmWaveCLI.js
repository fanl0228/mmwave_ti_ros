...
// (in-package ti_mmwave_tracker_rospkg.srv)
...
class mmWaveCLIRequest {
  ...
  static datatype() {
    ...
    return 'ti_mmwave_tracker_rospkg/mmWaveCLIRequest';
  }
...
class mmWaveCLIResponse {
  ...
  static datatype() {
    // Returns string type for a service object
    return 'ti_mmwave_tracker_rospkg/mmWaveCLIResponse';
  }
...
module.exports = {
  ...
  datatype() { return 'ti_mmwave_tracker_rospkg/mmWaveCLI'; }
};
